...
<body>
    <div class="container">
        ...
        <form action="#" method="post">
            ...
            <div>
                Name:<br>
                <input type="text" id="name" name="name" placeholder="John Doe" value="Jhn Doe" required>
            </div>

            <div>
                Phone Number:<br>
                <input type="tel" id="phone" name="phone" placeholder="123-456-7890" value="4083153683" required>
            </div>
            ...
            <div>
                Billing Address:<br>
                <input type="text" id="address-street" name="address" placeholder="Street Address" value="2822 Ben ave" required>
                <input type="text" id="address-city" name="address" placeholder="City" value="2822 Ben ave" required>
                <input type="text" id="address-state" name="address" placeholder="State" value="2822 Ben ave" required>
                <input type="text" id="address-areacode" name="address" placeholder="Area Code" value="2822 Ben ave" required>
            </div>

            <div>
                Name on Credit Card:<br>
                <input type="text" id="cc-name" name="cc-name" placeholder="John Doe" value="johndoe" required>
            </div>

            <div>
                Credit Card Number:<br>
                <input type="text" id="cc-number" name="cc-number" pattern="[0-9]{16}" placeholder="1234567890987654" value="1234567890987654" required>
            </div>
            ...
            <div>
                Credit Card CVV:<br>
                <input type="text" id="cc-cvv" name="cc-cvv" pattern="[0-9]{3,4}" placeholder="123" value="123" required>
            </div>
